...
const InputsProfile =({showninput, setShowninput, auth, serverPublic, eltt_vis, setEltt_vis,
                          elttvis, setElttvis, zIndex, setZIndex, setings, setSetings,
                          checkbox, setCheckbox, posterbtn, setPosterbtn, cam, setCam,
                          vid, setVid,frinds, setFrinds, addmedia, setAddmedia, muz, setMuz, user
})=>{
    return(
        <>
