                    ...
                    <nav className="side_bar_nav">
                        <ol className="side_bar_ol">
                            ...
                            <li id="l_ph" className="">
                                <Link to={"/albums519282746"} className="left_row">
                                    <div className="LeftMenu__icon">
                                        <svg fill="none" height="20" viewBox="0 0 20 20" width="20" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <li id="l_aud" className="">
                                <Link to={"/audios519282746"} className="left_row">
                                    <div className="LeftMenu__icon">
                                        <svg fill="none" height="20" viewBox="0 0 20 20" width="20" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <li id="l_ads" className="">
                                <Link to="/ads?act=office&amp;last=1&amp;utm_source=vk_left_menu"
                                   className="left_row" target="_blank">
                                    <div className="LeftMenu__icon">
